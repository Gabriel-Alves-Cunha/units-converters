						...
						<strong>
							<span style={{ fontSize: 15 }}>
								<span data-custom-class="subtitle">
									Last updated <bdt className="question">May 15, 2026</bdt>
								</span>
							</span>
						</strong>
					</span>
				...
				<div>
					...
					<div style={{ lineHeight: "1.5" }}>
						...
						<div style={{ lineHeight: "1.5" }}>
							...
							<a
								data-custom-class="link"
								href="https://app.termly.io/dsar/b26d1d2f-8d60-41f3-bcbe-fd0d0cfd17e2"
											...
											<span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
												<span data-custom-class="body_text">
													...
													<em>
														...
														law.
														<bdt className="block-component" /> We process the
														personal information for the following purposes
														listed below.
														<bdt className="statement-end-if-in-editor" /> We
														may also process your information for other purposes{" "}
														<bdt className="block-component" />
														only with your prior explicit
														<bdt className="else-block" /> consent.
													</em>
												</span>
											</span>
										</span>
