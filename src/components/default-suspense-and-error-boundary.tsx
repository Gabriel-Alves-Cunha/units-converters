...
export function LoadError({
	...
	zustandStores?: ZustandStores | undefined;
	...
	return (
		...
		>
			...
			<details className="text-xs">
				...
				<pre className="whitespace-pre-wrap bg-destructive/30 p-4 simple-scrollbar max-w-full rounded-md">
					{error?.stack}
				</pre>
			</details>
